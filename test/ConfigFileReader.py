...
class ConfigFileReader():
    ...
    def readConfigFile(context):
        ...
        ConfigFileReader.username = configs["username"].data
        ConfigFileReader.password = configs["password"].data
        ConfigFileReader.download_path = configs["download.path"].data.replace("^\"|\"$", "")
